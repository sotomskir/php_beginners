...
Class UnCalc{
	...
	public function __construct($ini_file){
		...
		//dump($this->arr);		
		echo 'Construct:jednostki wczytane.';
	}
	public function calc($cat,$value, $un1, $un2){
		return $value*$this->arr[$cat][$un1]/$this->arr[$cat][$un2];
	}
	public function ChkCatUn($cat,$un){
		return isset($this->arr[$cat][$un]);
	}
